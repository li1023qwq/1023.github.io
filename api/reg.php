...
<head>
	<meta charset="UTF-8">
	<title><?php echo $admin["title"] ?>-用户注册</title>
            ...
            <div class="logo">
               <a href="./index.php"><?php echo $admin["title"] ?></a></div>
                ...
                <li class="layui-nav-item to-index">
                    <a href="login.php">立即登录</a></li>
            </ul>
        </div>
        <div class="login layui-anim layui-anim-up">
        <div class="message">用户注册</div>
        <div id="darkbannerwrap"></div>
        <form class="am-form am-form-horizontal" action="/api/reg.php" method="post" name="loghitoke">
            <input name="user" placeholder="账号"  type="text" lay-verify="required" class="layui-input" >
            <hr class="hr15">
            <input name="name" lay-verify="required" placeholder="昵称"  type="text" class="layui-input">
            <hr class="hr15">            
            <input name="qq" placeholder="QQ"  type="text" lay-verify="required" class="layui-input" >
            <hr class="hr15">
            ...
            <a class="layui-btn" href="login.php" ><i class="layui-icon"></i>立即登录</a>
        </form>
    </div>
</body>
</html>
