    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        ?>
                                ...
                                <tr cate-id='<?php echo$row['id']?>' fid='0' >
                                  ...
                                  <td class="td-manage">
                                    <button class="layui-btn layui-btn layui-btn-xs" onclick="xadmin.open('聊天室','pwd.php?ltsid=<?php echo $row['id'] ?>')" ><i class="layui-icon">&#xe642;</i>进入</button>
        ...
        $sz=$res['name'];
                ?>
                                ...
                                <tr cate-id='<?php echo$row['id']?>' fid='0' >
                                  ...
                                  <td><?php echo$row['jj']?></td>
                                  <td class="td-manage">
                                    <button class="layui-btn layui-btn layui-btn-xs" onclick="xadmin.open('聊天室','chat.php?ltsid=<?php echo $row['id'] ?>')" ><i class="layui-icon">&#xe642;</i>进入</button>
                                    <button class="layui-btn layui-btn layui-btn-xs" onclick="xadmin.open('聊天室后台','chatadmin.php?ltsid=<?php echo $row['id'] ?>')" ><i class="layui-icon">&#xe642;</i>管理</button>
                                  </td>
                                </tr>
        <?php
