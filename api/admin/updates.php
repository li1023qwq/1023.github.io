...
<body>
	...
	<div class="sidebar">
		...
		<a class="active" href="../admin/updates.php">日志</a>
...
<div class="content">
  <div class="content">
  	...
  	<header>
  		...
  		<form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
  			...
  			<input type="text" name="update_at" placeholder="更新时间" required><br>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "INSERT INTO updates (title, content, update_at, cerated_at) VALUES ('$title', '$content', '$update_at', '$cerated_at')";
  
      if ($conn->query($sql) === TRUE) {
          echo "日志发布成功";
      } else {
          echo "日志发布失败：" . $conn->error;
      }
  }
